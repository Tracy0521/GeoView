"""add remote model source fields

Revision ID: c4f37b0f2a91
Revises: a392e2cc5a37
...
revision = 'c4f37b0f2a91'
down_revision = 'a392e2cc5a37'
branch_labels = None
depends_on = None


def upgrade():
    with op.batch_alter_table('model_record') as batch_op:
